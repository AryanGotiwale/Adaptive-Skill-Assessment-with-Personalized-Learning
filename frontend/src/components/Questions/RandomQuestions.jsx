// // src/components/Questions/RandomQuestions.jsx
...
//   return (
//     <div>
//       <h1>Random Aptitude Question</h1>
//       {question ? (
//         <div>
...
//             ))}
//           </ul>
//           <p onClick={()=>{setShowExplanation(true)}} style={{cursor:"pointer"}}>Show Explanation</p> 
...
//           {showExplanation && <p><strong>Explanation:</strong>{question.explanation}</p>}
...
//   const [showAnswer, setShowAnswer] = useState(false);
//   const [feedback, setFeedback] = useState('');
//   const [questionNo, setQuestionNo] = useState(1); // Start from 1
//   const [showExplanation, setShowExplanation] = useState(false);
//   const [completed, setCompleted] = useState(false); // ✅ Track if limit is reached

//   // Fetch a new random question
//   const fetchQuestion = () => {
//     if (questionNo > 30) {
//       setCompleted(true); // ✅ Stop at 30
//       return;
//     }
...
//   return (
//     <div>
//       <h1>Random Aptitude Questions</h1>
//       {!completed ? (
//         question ? (
//           <div>
//             <h2>Question {questionNo}: {question.question}</h2>
...
//       ) : (
//         <div>
//           <h2>You have completed all 30 questions! 🎉</h2>
